...
export default class MessageController implements MessageControllerI{
    ...
    public static getInstance = (app: Express) : MessageController =>{
        if (MessageController.messageController === null){
            ...
            app.post("/api/messages/senders/:senderUid/receivers/:receiverUid", MessageController.messageController.userMessagesUser);
            app.get("/api/messages/senders/:uid/receivers", MessageController.messageController.findAllSentMessages);
            app.get("/api/messages/receivers/:uid/senders", MessageController.messageController.findAllReceivedMessages);
            app.delete("/api/messages/senders/:senderUid/receivers/:receiverUid", MessageController.messageController.deleteMessage);
        }
    ...
    userMessagesUser = (req: Request, res: Response) =>
        MessageController.messageDao.userMessagesUser(req.params.senderUid, req.params.receiverUid, req.body)
            .then((message: Message) => res.json(message));
